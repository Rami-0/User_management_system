...
private:
	...
	std::string _PrepareTransferLogRecord(float Amount, clsBankClient DestinationClient, std::string UserName,
		std::string Separator = "#//#")
	{
		...
		TransferLogRecord += std::to_string(Amount) + Separator;
		TransferLogRecord += std::to_string(accountBalance) + Separator;
		TransferLogRecord += std::to_string(DestinationClient.getAccountBalance()) + Separator;
...
public:
	...
	bool Transfer(float Amount, clsBankClient& DestinationClient, std::string user_name) {
